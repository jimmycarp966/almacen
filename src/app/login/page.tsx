        ...
        <div className="relative flex min-h-screen w-full flex-col">
            ...
            <header className="flex w-full items-center justify-between border-b border-[#f4f1f1] px-10 py-5 bg-white/80 backdrop-blur-sm fixed top-0 z-50">
                <div className="flex items-center gap-4 cursor-pointer">
                    ...
                    <h2 className="text-[#171212] text-xl font-bold leading-tight tracking-tight">Super Aguilares</h2>
                </div>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-[#826868] text-base font-normal">
                                {needsName
                                    ...
                                    : 'Ingresa tu número para acceder a tu cuenta'}
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            <div className="space-y-1">
                                <label className="text-sm font-semibold text-[#171212] ml-1" htmlFor="phone">
                                    Número de celular
                                </label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <span className="material-symbols-outlined text-primary group-focus-within:scale-110 transition-transform duration-200">
                                            smartphone
                                        </span>
                                    </div>
                                    <input
                            ...
                            {needsName && (
                                <div className="space-y-1 animate-fade-in-up">
                                    <label className="text-sm font-semibold text-[#171212] ml-1" htmlFor="nombre">
                                        ¿Cuál es tu nombre?
                                    </label>
                                    <div className="relative group">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="group relative w-full flex justify-center py-4 px-4 border border-transparent rounded-xl text-white bg-primary hover:bg-[#a92b2b] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary font-bold text-lg shadow-lg shadow-primary/30 transition-all duration-200 transform active:scale-[0.98] disabled:opacity-70"
                            >
                            ...
                            <div className="text-center px-4">
                                <p className="text-xs text-[#826868] leading-relaxed">
                                    Solo pedimos tu número para identificar tus pedidos.
                                    <br className="hidden sm:block" /> No enviamos spam ni publicidad.
                                </p>
                            </div>
                        </form>
                    </div>
