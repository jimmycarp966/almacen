// Script para agregar productos faltantes desde la lista de WhatsApp
...
const productosFaltantes = [
    // ===== VINOS FALTANTES =====
    {
        ...
        categoria_id: '9a98d5e4-59fd-438b-9b03-ae68507dad5d', // Vinos
        precio: 3800,
        stock: 18,
    ...
    // ===== GASEOSAS FALTANTES =====
    {
        ...
        categoria_id: '7918dc62-61a4-46f4-8381-c7eae3e95b57', // Gaseosas
        precio: 3200,
        stock: 24,
    ...
    // ===== CERVEZAS FALTANTES =====
    {
        ...
        categoria_id: 'b8b43347-eaeb-4aa7-9cf9-2414bac6eaaf', // Cervezas y Jugos
        precio: 1400,
        stock: 60,
    ...
    // ===== HIGIENE FALTANTES =====
    {
        codigo: 'HIG-006',
        nombre: 'Minora',
        categoria_id: '1ebcf58b-7fdd-41ce-a327-e232cdc2e888', // Higiene y P&G
        precio: 900,
        stock: 60,
    ...
    // ===== LIMPIEZA FALTANTES =====
    {
        ...
        categoria_id: 'f115a67a-d3e5-41ce-81da-2b1a15d68fcc', // Limpieza
        precio: 2800,
        stock: 30,
    ...
    // ===== SNACKS FALTANTES =====
    {
        ...
        categoria_id: 'a6a61fd6-b480-44e3-a945-fc0b315e0b32', // Snacks
        precio: 3200,
        stock: 24,
    ...
    // ===== ALMACÉN FALTANTES =====
    {
        ...
        categoria_id: 'b44cbef4-f818-4972-9a39-f4bb1049753f', // Almacén/Varios
        precio: 2800,
        stock: 30,
    ...
    // ===== PANIFICACIÓN FALTANTE =====
    {
        codigo: 'PAN-004',
        nombre: 'Pan Francés',
        categoria_id: '79897b8c-83bb-4b9a-af5b-d51f9a45d799', // Panificación
        precio: 1200,
        stock: 40,
    ...
    // ===== LÁCTEOS FALTANTES =====
    {
        ...
        categoria_id: 'b44cbef4-f818-4972-9a39-f4bb1049753f', // Almacén/Varios (reutilizamos esta categoría)
        precio: 1800,
        stock: 48,
    ...
    // ===== HELADOS FALTANTES =====
    {
        ...
        categoria_id: '73946f3f-6702-4597-9bec-1168e5a4c7c5', // Helados
        precio: 900,
        stock: 48,
...
async function main() {
    ...
    try {
        // Obtener productos actuales para verificar duplicados por código
        const { data: productosExistentes, error: errorExist } = await supabase
            .from('productos')
            .select('codigo')
        ...
        for (const producto of productosParaAgregar) {
            ...
            if (!error) {
                ...
                console.log(`❌ ${producto.codigo}: Error - ${error.message}`)
                errores.push({ codigo: producto.codigo, error: error.message })
            }
        }
